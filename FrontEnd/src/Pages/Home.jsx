        ...
        <div className="grid grid-cols-1 md:grid-cols-2 relative">
          <div className="flex flex-col gap-3">
            <h2 className="font-bold text-4xl">
              Every drop is a <span className="text-rose-500">LifeLine</span>.
            </h2>
            <p className="text-gray-400">
              LifeFlow matches verified donors with patients in critical need
          ...
          <div className="flex gap-20 mt-8 md:absolute bottom-2 right-50">
            <NavLink
              to="/findDonor"
              className="flex gap-2 text-center py-2 px-2 border text-white bg-rose-500 rounded-lg"
            >
              Find Donor <FaArrowCircleRight className="mt-1" />
            </NavLink>
            <NavLink to="/donateBlood" className="py-2 px-2 border rounded-lg">
              Donate Blood
            </NavLink>
          </div>
        </div>
