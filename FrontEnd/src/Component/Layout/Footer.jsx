...
const Footer = () => {
  return (
    <div className='p-2 bg-gray-300 shadow-gray-400 shadow-2xl'>
        <div>LOGO</div>

        <div className='grid grid-cols-2 gap-9 pl-5 md:grid-cols-4 justify-between'>

            <div>
                <span className='text-rose-400'>Connecting verified donors with patients in need - clinical precision meets human compassion.</span>
